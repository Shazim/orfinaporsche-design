      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 py-4 sm:py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm">
            ...
            <span className="text-black font-medium">Hands</span>
          </nav>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start space-x-3">
                        ...
                        <span className="text-sm sm:text-base leading-relaxed">
                          White hour and non-pointed minute hands that are lumed
                          with Tritium
                        </span>
                      </li>
                      <li className="flex items-start space-x-3">
                ...
                <div className="flex flex-col items-center justify-center">
                  <div
                    ...
                    onClick={() =>
                      setFullScreenImage({
                        src: "/images/Hands/7750 Handset.jpg",
                        alt: "7750 Handset",
                        title: "7750 Handset",
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div className="flex flex-col items-center justify-center order-2 lg:order-1">
                  <div
                    ...
                    onClick={() =>
                      setFullScreenImage({
                        src: "/images/Hands/7176-Civilian-Handset.jpg",
                ...
                <div className="order-1 lg:order-2 space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 sm:p-8 rounded-lg border-l-4 border-black">
                    <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
                      The 7176 ushered in a new handset differentiated from the
                      7750 with:
                    </p>
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start space-x-3">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="flex flex-col items-center justify-center">
                  <div
                    ...
                    onClick={() =>
                      setFullScreenImage({
                        src: "/images/Hands/Militaryhandset.jpg",
