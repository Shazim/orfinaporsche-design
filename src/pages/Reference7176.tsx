      ...
      <div className="bg-porsche-gray py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="font-sans text-sm">
            ...
            <span className="mx-2 text-porsche-dark-gray">/</span>
            <span className="text-porsche-black font-medium">Ref. 7176</span>
          </nav>
        </div>
      </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="flex-1">
              <h1 className="font-sans text-5xl md:text-6xl font-light text-porsche-black mb-4 uppercase tracking-wider text-left">
                Reference <span className="text-porsche-black">7176, 7176 Military, 7176D, 7176S</span>
              </h1>
              <div className="mb-8">
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
              <img 
                ...
                alt="Baseline Dial Ref. 7176" 
                className="w-[28rem] h-[28rem] object-contain bg-porsche-gray rounded shadow mb-2"
              />
              <span className="text-base md:text-lg text-gray-600 mt-4">Baseline Dial Ref. 7176</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="px-8 py-4 bg-charcoal">
              <h3 className="font-playfair text-2xl font-bold text-white">Reference 7176 Specifications</h3>
            </div>
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    ...
                    <span className="font-inter text-charcoal">7176</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    <span className="font-inter font-medium text-gray-700">Production Years</span>
                    <span className="font-inter text-charcoal">1976-1983</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-200">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    ...
                    <span className="font-inter text-charcoal">1000–3000 (approx.)</span>
                  </div>
                </div>
              </div>
            </div>
