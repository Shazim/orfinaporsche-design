      ...
      <section className="pt-12 pb-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-inter text-gray-700 leading-relaxed mb-8 text-left">
            There are three "hero" generations of the Reference 7750. We will outline a brief overview below, before going into deeper variations across all generations.
          </p>

          {/* Generation 1 Row */}
          <div className="flex flex-col md:flex-row md:items-center md:gap-12 mb-16">
            <div className="flex-1">
              <h2 className="font-sans text-2xl font-bold text-porsche-black mb-2">Generation 1</h2>
              <ul className="list-disc ml-8 text-gray-700 mb-4">
                <li><strong>Production Years:</strong> 1973-1974</li>
                <li><strong>Case:</strong> Mk. 1</li>
                <li><strong>Finishes:</strong> Powder Coat Black, Silver/Sable</li>
                <li><strong>Caseback:</strong> Mk. 1</li>
                <li><strong>Rehaut:</strong> 1Mile, 1KM, Advertisement</li>
                <li><strong>Dial:</strong> Orfina Dial</li>
              </ul>
            </div>
            <div className="flex flex-col items-center md:w-80 mt-6 md:mt-0" style={{position: 'relative', left: '-384px'}}>
              <img 
              ...
              />
              <div className="italic text-gray-600 text-center">7750 Generation 1 "Orfina"</div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-12 mb-16">
            <div className="flex-1">
              <h2 className="font-sans text-2xl font-bold text-porsche-black mb-2">Generation 2</h2>
              <ul className="list-disc ml-8 text-gray-700 mb-4">
                <li><strong>Production Years:</strong> 1974-1974</li>
                <li><strong>Case:</strong> Mk. 1</li>
                <li><strong>Finishes:</strong> Powder Coat Black, Silver/Sable</li>
                <li><strong>Caseback:</strong> Mk. 2</li>
                <li><strong>Rehaut:</strong> 1Mile, 1KM, Advertisement</li>
                <li><strong>Dial:</strong> PD Dial</li>
              </ul>
            </div>
            <div className="flex flex-col items-center md:w-80 mt-6 md:mt-0" style={{position: 'relative', left: '-384px'}}>
              <img 
                ...
                className="w-32 h-32 object-contain bg-porsche-gray rounded shadow mb-2" 
              />
              <div className="italic text-gray-600 text-center">7750 Generation 2 "Flat PD Dial"</div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-12 mb-4">
            <div className="flex-1">
              <h2 className="font-sans text-2xl font-bold text-porsche-black mb-2">Generation 3</h2>
              <ul className="list-disc ml-8 text-gray-700 mb-4">
                <li><strong>Production Years:</strong> 1975-1976</li>
                <li><strong>Case:</strong> Mk. 2</li>
                <li><strong>Finishes:</strong> Black PVD, Silver/Sable</li>
                <li><strong>Caseback:</strong> Mk. 2, Mk. 3</li>
                <li><strong>Rehaut:</strong> 1Mile, 1KM, Advertisement</li>
                <li><strong>Dial:</strong> PD Dial</li>
              </ul>
            </div>
            <div className="flex flex-col items-center md:w-80 mt-6 md:mt-0" style={{position: 'relative', left: '-384px'}}>
              <img 
                ...
                alt="7750 Generation 3 Thin PD Dial" 
                className="w-32 h-32 object-contain bg-porsche-gray rounded shadow mb-2" 
              />
              <div className="italic text-gray-600 text-center">7750 Generation 3 "Thin PD Dial"</div>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    ...
                    <span className="font-inter text-charcoal">6000–9000 (approx.)</span>
                  </div>
                </div>
              </div>
            </div>
