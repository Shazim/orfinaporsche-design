    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="font-sans text-2xl font-normal text-porsche-black mb-8 uppercase tracking-wide">Our Vision</h2>
      ...
      {/* Team */}
      <section className="py-20 bg-porsche-gray">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-sans text-3xl font-light text-porsche-black text-center mb-20 uppercase tracking-wider">Our Team</h2>
          
          <div className="grid md:grid-cols-3 gap-16">
            <div className="text-center">
              <div className="w-32 h-32 bg-porsche-light-gray mx-auto mb-8"></div>
              <h3 className="font-sans text-xl font-normal text-porsche-black mb-2 uppercase tracking-wide">Marcus Weber</h3>
              <p className="font-sans text-porsche-dark-gray font-normal mb-6 text-sm uppercase tracking-wider">Chief Curator & Researcher</p>
              <p className="font-sans text-porsche-dark-gray leading-relaxed">
            ...
            <div className="text-center">
              <div className="w-32 h-32 bg-porsche-light-gray mx-auto mb-8"></div>
              <h3 className="font-sans text-xl font-normal text-porsche-black mb-2 uppercase tracking-wide">Elena Rodriguez</h3>
              <p className="font-sans text-porsche-dark-gray font-normal mb-6 text-sm uppercase tracking-wider">Photography Director</p>
              <p className="font-sans text-porsche-dark-gray leading-relaxed">
            ...
            <div className="text-center">
              <div className="w-32 h-32 bg-porsche-light-gray mx-auto mb-8"></div>
              <h3 className="font-sans text-xl font-normal text-porsche-black mb-2 uppercase tracking-wide">Thomas Mitchell</h3>
              <p className="font-sans text-porsche-dark-gray font-normal mb-6 text-sm uppercase tracking-wider">Technical Specialist</p>
              <p className="font-sans text-porsche-dark-gray leading-relaxed">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-sans text-2xl font-normal text-porsche-black mb-8 uppercase tracking-wide">Collaboration & Credits</h2>
          
          <div className="space-y-12">
            <div>
              <h3 className="font-sans text-xl font-normal text-porsche-black mb-4 uppercase tracking-wide">Special Thanks</h3>
              ...
              <ul className="font-sans text-lg text-porsche-dark-gray space-y-3 ml-6">
            ...
            <div>
              <h3 className="font-sans text-xl font-normal text-porsche-black mb-4 uppercase tracking-wide">Contributors</h3>
              <p className="font-sans text-lg text-porsche-dark-gray leading-relaxed">
      ...
      {/* Contact */}
      <section className="py-20 bg-porsche-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-sans text-3xl font-light text-white mb-8 uppercase tracking-wider">Get In Touch</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a 
              ...
              className="bg-white text-porsche-black px-8 py-4 font-sans font-normal text-sm uppercase tracking-wider hover:bg-porsche-gray transition-colors"
            >
              Contact Us
            </a>
            <a 
              href="#" 
              className="border border-white text-white px-8 py-4 font-sans font-normal text-sm uppercase tracking-wider hover:bg-white hover:text-porsche-black transition-all"
            >
              Follow Our Research
            </a>
          </div>
